...
export default function Footer() {
  ...
  return (
    <footer className="sym-footer">
      <div className="sym-footer-container">
        
        <Link className="sym-brand" to="/" onClick={scrollToTop}>
          <img src="/static/assets/Antariksh_Logo.png" alt="ANTARIKSH" className="sym-logo-img" />
        </Link>
        
        <div className="sym-social-icons">
        ...
        <p className="sym-location">Vishwakarma Institute of Technology, Pune</p>
        <span className="sym-copyright">© {new Date().getFullYear()} Antariksh Club</span>
